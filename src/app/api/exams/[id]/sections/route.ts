// POST /api/exams/[id]/sections - Create exam section
// GET /api/exams/[id]/sections - Get all sections for an exam
...
export async function POST(
  ...
  console.log('🔥 POST /api/exams/[id]/sections - Starting');
  console.log('📝 Params received:', params);
  console.log('📝 Exam ID from params:', params.id);
  ...
  try {
    ...
    console.log('👤 User lookup result:', user ? `Found: ${user.role}` : 'Not found');
    ...
    console.log('📋 Exam lookup result:', exam ? `Found: ${exam.name}` : 'Not found');
    ...
    if (user.role !== 'ADMIN' && user.role !== 'MODERATOR' && exam.createdById !== userId) {
